 ...
 * packing/unpacking quad data in an array of integers. Used for the
 * baseline implementations in FREX. Renderers do not have to use this.
 */
public abstract class MeshEncodingHelper {
	...
	public static final int VERTEX_COLOR1 = VERTEX_COLOR0 + MESH_VERTEX_STRIDE;
	public static final int VERTEX_COLOR2 = VERTEX_COLOR1 + MESH_VERTEX_STRIDE;
	public static final int VERTEX_COLOR3 = VERTEX_COLOR2 + MESH_VERTEX_STRIDE;
	...
	public static final int VERTEX_LIGHTMAP1 = VERTEX_LIGHTMAP0 + MESH_VERTEX_STRIDE;
	...
	public static int packNormalizedUV(float u, float v) {
	...
	public static int packColorFromFloats(float red, float green, float blue, float alpha) {
		return packColorFromBytes((int) (red * 255.0F), (int) (green * 255.0F), (int) (blue * 255.0F), (int) (alpha * 255.0F));
	}

	public static int packColorFromBytes(int red, int green, int blue, int alpha) {
		return red | (green << 8) | (blue << 16) | (alpha << 24);
	}
