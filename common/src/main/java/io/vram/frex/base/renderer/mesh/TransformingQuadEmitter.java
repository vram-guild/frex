...
public class TransformingQuadEmitter extends BaseQuadEmitter implements PooledQuadEmitter {
	...
	@Override
	public TransformingQuadEmitter withTransform(InputContext context, QuadTransform transform) {
